...
cx q[14],q[13];
cx q[13],q[14];
u3(1.5707963267948968,0.0,7.0685834705770345) q[14];
u1(0.7853981633974483) q[6];
cx q[13],q[6];
u1(0.7853981633974483) q[13];
u1(-0.7853981633974483) q[6];
...
cx q[4],q[3];
cx q[3],q[4];
u3(1.5707963267948968,0.0,7.0685834705770345) q[6];
cx q[4],q[6];
cx q[6],q[4];
cx q[4],q[6];
cx q[6],q[13];
...
u3(3.141592653589793,0.0,3.141592653589793) q[28];
cx q[25],q[29];
cx q[29],q[25];
cx q[25],q[29];
cx q[24],q[25];
...
cx q[25],q[24];
cx q[25],q[29];
u3(1.5707963267948968,0.0,7.0685834705770345) q[26];
cx q[26],q[27];
u1(-0.7853981633974483) q[27];
cx q[18],q[27];
cx q[27],q[18];
...
cx q[11],q[12];
cx q[11],q[17];
u3(1.5707963267948968,0.0,7.0685834705770345) q[15];
cx q[17],q[11];
cx q[11],q[17];
cx q[29],q[25];
cx q[25],q[29];
